...
public class Exportxls implements Runnable {
	private TableModel tableModel;

	public Exportxls(TableModel tableModel) {
	...
	public void exportarAExcel(TableModel tableModel) {
		...
		// Escribir el archivo
		try (FileOutputStream out = new FileOutputStream("datos_exportados_STOCK.xlsx")) {
			workbook.write(out);
